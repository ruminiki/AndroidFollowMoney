...
public class DeleteMovement {

    public OnLoadListener onLoadlistener;
    public Context context;

    public DeleteMovement(OnLoadListener onLoadlistener, Context context) {
        this.onLoadlistener = onLoadlistener;
        this.context = context;
    }

    public void execute(Integer id) {
        final String URL = "http://192.168.1.13/followMoneyRest/movements/"+id;

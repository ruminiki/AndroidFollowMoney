...
public class GetBankAccounts {
    ...
    public GetBankAccounts(OnLoadListener onLoadlistener, Context context) {
    ...
    public void execute(Integer user) {
        ...
        String URL = "http://192.168.1.10/followMoneyRest/bankAccounts/user/"+user;
                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            ...
                            onLoadlistener.onLoaded( Arrays.asList(gson.fromJson(response.toString(4),BankAccount[].class)) );
    ...
    public interface OnLoadListener {
        void onLoaded(List<BankAccount> bankAccounts);
